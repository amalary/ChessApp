...
To run the backend '.\.venv\Scripts\python -m uvicorn app.main:app --env-file ..\.env --host 127.0.0.1 --port 8010' in the backend directory using a command prompt in CLI 
Long in page test rout " http://localhost:3000/login-test " 
App test page route " http://localhost:3001/solve-test " 